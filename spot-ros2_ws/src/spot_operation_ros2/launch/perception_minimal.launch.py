...
def generate_launch_description():
    ...
    secondary_camera_info_topic_pattern = LaunchConfiguration(
    ...
    return LaunchDescription(
        [
            ...
            DeclareLaunchArgument(
                "rgb_topic",
                default_value=PythonExpression(
                    ["'/hand/rgb' if '", sim, "' == 'true' else '/camera/hand/image'"]
                ),
            ...
            DeclareLaunchArgument(
                ...
                default_value=PythonExpression(
                    [
                        "'/hand/camera_info' if '",
                        sim,
                        "' == 'true' else '/camera/hand/camera_info'",
                    ]
                ),
            ...
            DeclareLaunchArgument(
                ...
                default_value=PythonExpression(
                    [
                        "'/hand/depth' if '",
                        sim,
                        "' == 'true' else '/depth_registered/hand/image'",
                    ]
                ),
            ...
            DeclareLaunchArgument(
                ...
                default_value=PythonExpression(
                    [
                        "'/hand/camera_info' if '",
                        sim,
                        "' == 'true' else '/depth_registered/hand/camera_info'",
                    ]
                ),
            ...
            DeclareLaunchArgument(
                ...
                default_value=PythonExpression(
                    ["'/{cam}/rgb' if '", sim, "' == 'true' else '/camera/{cam}/image'"]
                ),
            ...
            DeclareLaunchArgument(
                ...
                default_value=PythonExpression(
                    [
                        "'/{cam}/depth' if '",
                        sim,
                        "' == 'true' else '/depth_registered/{cam}/image'",
                    ]
                ),
            ...
            DeclareLaunchArgument(
                ...
                default_value=PythonExpression(
                    [
                        "'/{cam}/camera_info' if '",
                        sim,
                        "' == 'true' else '/camera/{cam}/camera_info'",
                    ]
                ),
            ...
            DeclareLaunchArgument(
                ...
                default_value=PythonExpression(
                    [
                        "'/{cam}/segmentation_mask' if '",
                        sim,
                        "' == 'true' else '/camera/{cam}/segmentation_mask'",
                    ]
                ),
            ...
            DeclareLaunchArgument(
                ...
                default_value=PythonExpression(
                    [
                        "'/hand/segmentation_mask' if '",
                        sim,
                        "' == 'true' else '/camera/hand/segmentation_mask'",
                    ]
                ),
                ...
                parameters=[
                    {
                        ...
                        "secondary_cameras": ParameterValue(
                            secondary_cameras, value_type=str
                        ),
                        "rgb_topic": rgb_topic,
